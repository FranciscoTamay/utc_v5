            ...
            <table id="pro5" class="xd display responsive nowrap" style="width:95%">
                <thead class="bg-darck text-center">
                    <tr>
                        ...
                        <th class="fin text-center">GRADO PROFESOR</th>
            ...
            <div class="modal-body">
                ...
                <form id="frmGrados" method="POST" action="{{ url('grados') }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="grado_nombre" class="form-control" maxlength="50" placeholder="Código del Profesor" required>
                    </div>
